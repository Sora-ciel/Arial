  ...
  <div class="track">
    {#each slots as slot}
      <div
        ...
        style={`left:${slot.atBeat * beatWidth}px; width:${slotWidth}px; background:${slotFill(slot)};`}
      >
    ...
    {/each}
    <div class="indicator" style={`left:${activeBeat * beatWidth}px;`}></div>
  </div>
